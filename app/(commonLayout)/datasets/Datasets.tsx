...
const Datasets = ({
  ...
  const { data, isLoading, setSize, mutate } = useSWRInfinite(
    (pageIndex: number, previousPageData: DataSetListResponse) => getKey(pageIndex, previousPageData, tags, keywords, includeAll, tenant_id),
    fetchDatasets,
  ...
  return (
    <nav style={{ height: 'calc(100% - 90px)' }} className='grid shrink-0 grow grid-cols-1 content-start gap-4 px-12 pt-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 overflow-y-auto'>
