...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  const {
    children,
    params: { datasetId, detailContentType },
  } = props
  ...
  const navigation = useMemo(() => {
    const baseNavigation = [
      { key: 'hitTesting', name: t('common.datasetMenus.hitTesting'), href: `/datasets/${datasetId}/hitTesting`, icon: RiFocus2Line, selectedIcon: RiFocus2Fill },
      // { name: t('common.datasetMenus.settings'), href: `/datasets/${datasetId}/settings`, icon: RiEqualizer2Line, selectedIcon: RiEqualizer2Fill },
      { key: 'back', name: '返回', href: '', icon: RiArrowGoBackLine, selectedIcon: RiArrowGoBackLine },
    ]
