...
import GlobalUrl, { checkBrowserUrl } from '@/GlobalUrl'
...
const CallStatistics: React.FC<Props> = ({ setActiveTab }) => {
  ...
  const getDataList = () => {
    API.getCallStatisticsList({
      url: `${GlobalUrl.defaultUrlIp}/v1/workflow-api/queryInfo`,
      // url: `http://117.89.254.31:32321/v1/workflow-api/queryInfo`,
      body: {
        pageNum,
        pageSize,
        province: province || '',
  ...
  const handleDetail = (rd) => {
    API.getCallStatisticsDetail({
      url: `${GlobalUrl.defaultUrlIp}/v1/workflow-api/queryDetail`,
      // url: `http://117.89.254.31:32321/v1/workflow-api/queryDetail`,
      body: {
  ...
  const getProvinceList = () => {
    ...
    // alert(window.location.href.includes('agent-platform-web'))
    API.getProvList({
      url: `${GlobalUrl.defaultUrlIp}/v1/workflow-api/queryProvList`,
  ...
  return (
    <>
      <Card className='call-statistics mt-[24px]'>
