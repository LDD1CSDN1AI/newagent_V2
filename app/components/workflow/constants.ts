...
import AgentNodeDefault from './nodes/agent-node/default'
import RAGNodeDefault from './nodes/rag-node/default'
...
import ParameterPasserDefault from './nodes/parameter-passer/default'
...
export const NODES_EXTRA_DATA: Record<BlockEnum, NodesExtraData> = {
  ...
  [BlockEnum.AgentNode]: {
    ...
    availablePrevNodes: [],
    availableNextNodes: [],
    getAvailablePrevNodes: AgentNodeDefault.getAvailablePrevNodes,
    getAvailableNextNodes: AgentNodeDefault.getAvailableNextNodes,
    checkValid: AgentNodeDefault.checkValid,
  },
  [BlockEnum.RAGNode]: {
    author: 'lianghongliang',
    about: '',
    availablePrevNodes: [],
    availableNextNodes: [],
    getAvailablePrevNodes: RAGNodeDefault.getAvailablePrevNodes,
    getAvailableNextNodes: RAGNodeDefault.getAvailableNextNodes,
    checkValid: RAGNodeDefault.checkValid,
  },
  [BlockEnum.IfElse]: {
    author: 'Dify',
    about: '',
  ...
  [BlockEnum.ParameterPasser]: {
    author: 'Dify',
    about: '',
    availablePrevNodes: [],
    availableNextNodes: [],
    getAvailablePrevNodes: ParameterPasserDefault.getAvailablePrevNodes,
    getAvailableNextNodes: ParameterPasserDefault.getAvailableNextNodes,
    checkValid: ParameterPasserDefault.checkValid,
  },
  [BlockEnum.Tool]: {
    author: 'Dify',
    about: '',
...
export const NODES_INITIAL_DATA = {
  ...
  [BlockEnum.AgentNode]: {
    type: BlockEnum.AgentNode,
    title: '',
    desc: '',
    query_variable_selector: [],
    dataset_ids: [],
    retrieval_mode: 'single',
    ...AgentNodeDefault.defaultValue,
  },
  [BlockEnum.RAGNode]: {
    type: BlockEnum.RAGNode,
    title: '',
    desc: '',
    query_variable_selector: [],
    dataset_ids: [],
    retrieval_mode: 'single',
    ...RAGNodeDefault.defaultValue,
  },
  [BlockEnum.IfElse]: {
  ...
  [BlockEnum.ParameterPasser]: {
    type: BlockEnum.ParameterPasser,
    title: '',
    desc: '',
    variables: [],
    ...ParameterPasserDefault.defaultValue,
  },
  [BlockEnum.VariableAssigner]: {
...
export const SUPPORT_OUTPUT_VARS_NODE = [
  ...
  BlockEnum.IfElse, BlockEnum.ParameterExtractor, BlockEnum.ParameterPasser, BlockEnum.Iteration, BlockEnum.AgentNode, BlockEnum.RAGNode, BlockEnum.Loop, BlockEnum.Answer, BlockEnum.DocExtractor,
]
...
export const AGENT_NODE_OUTPUT_STRUCT: Var[] = [
  {
    variable: 'output',
    type: VarType.string,
  },
...
export const RAG_NODE_OUTPUT_STRUCT: Var[] = [
  {
    variable: 'output',
    type: VarType.string,
  },
