...
import AgentNodeNode from './agent-node/node'
import AgentNodePanel from './agent-node/panel'
import RAGNodeNode from './rag-node/node'
import RAGNodePanel from './rag-node/panel'
...
import ParameterPasserNode from './parameter-passer/node'
import ParameterPasserPanel from './parameter-passer/panel'
...
export const NodeComponentMap: Record<string, ComponentType<any>> = {
  ...
  [BlockEnum.AgentNode]: AgentNodeNode,
  [BlockEnum.RAGNode]: RAGNodeNode,
  ...
  [BlockEnum.ParameterPasser]: ParameterPasserNode,
...
export const PanelComponentMap: Record<string, ComponentType<any>> = {
  ...
  [BlockEnum.AgentNode]: AgentNodePanel,
  [BlockEnum.RAGNode]: RAGNodePanel,
  ...
  [BlockEnum.ParameterPasser]: ParameterPasserPanel,
