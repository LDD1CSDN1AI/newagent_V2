          ...
          <div className='space-y-1'>
            {
              ...
              [SupportUploadFileTypes.document].map((type: SupportUploadFileTypes) => (
                <FileTypeItem
                  key={type}
                  ...
                  selected={allowed_file_types && allowed_file_types.includes(type)}
            ...
            {/* <FileTypeItem
              ...
              selected={allowed_file_types && allowed_file_types.includes(SupportUploadFileTypes.custom)}
              onToggle={handleSupportFileTypeChange}
