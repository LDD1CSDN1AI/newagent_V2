...
import { DefaultValueForm, ErrorHandleTypeEnum } from './nodes/_base/components/error-handle/types'
import { WorkflowRetryConfig } from './nodes/_base/components/retry/types'
...
export enum BlockEnum {
  ...
  ParameterPasser = 'parameter-passer',
  Iteration = 'iteration',
  Loop = 'loop',
