...
const FeaturePanel: FC<IFeaturePanelProps> = ({
  ...
  return (
    <div
      className={cn(className, isFocus && 'border border-[#2D0DEE]', 'rounded-xl', noBodySpacing && '!pb-0')}
      style={isFocus
        ? {
    ...
    >
      {/* Header */}
      <div className={cn('px-0', hasHeaderBottomBorder && 'border-b border-gray-100')}>
      ...
      {/* Body */}
      {children && (
        <div className={cn(!noBodySpacing && ' px-0')}>
          {children}
        </div>
      )}
    </div>
