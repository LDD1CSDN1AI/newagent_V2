...
const iconMap = {
  add: <PlusCircleOutlined className='w-3.5 h-3.5' />,
...
const OperationBtn: FC<IOperationBtnProps> = ({
  ...
  return (
    <div
      className={cn(className, 'flex items-center rounded-md h-7 px-3 space-x-1 text-gray-700 cursor-pointer hover:bg-gray-200 hover:text-[#216EFF] select-none')}
      onClick={onClick}>
      <div>
        {iconMap[type]}
      </div>
