...
const AddToolModal: FC<Props> = ({
  ...
  const getAllTools = async () => {
    setListLoading(true)
    const buildInTools = await fetchAllTools(getQueryParams('tenant_id'))
    const customTools = await fetchAllCustomTools(getQueryParams('tenant_id'))
    const workflowTools = await fetchAllWorkflowTools(getQueryParams('tenant_id'))
