...
const StepOne = ({
  ...
  return (
    <div style={{ marginLeft: '110px' }} className='h-full w-full overflow-x-auto'>
      <div className='flex h-full w-full min-w-[1440px]'>
        <div style={{ textAlign: 'center' }} className='relative h-full w-full overflow-y-auto'>
          <div className='flex justify-end'>
            <div className={classNames(s.form)}>
              {/* {
                shouldShowDataSourceTypeList && (
                  <div style={{ textAlign: 'left' }} className={classNames(s.stepHeader, 'text-text-secondary system-md-semibold')}>
