  ...
  const filteredList = useMemo(() => {
    if (currCategory === allCategoriesEn) {
      if (!currentType)
        ...
        return allList.filter(item => (item.app.mode === 'chat' || item.app.mode === 'metabolic'))
      ...
      if (!currentType)
        ...
        return allList.filter(item => (item.app.mode === 'chat' || item.app.mode === 'metabolic') && item.category === currCategory)
      else if (currentType === 'agent')
