...
const ModelSelector: FC<ModelSelectorProps> = ({
  ...
  const swappedModelList = modelList.length === 2 ? [modelList[1], modelList[0]] : [...modelList];
  modelList = swappedModelList;
  // const temp = modelList[0].models[0];
  // modelList[0].models[0] = modelList[0].models[1];
  // modelList[0].models[1] = temp;
  const {
    currentProvider,
    currentModel,
