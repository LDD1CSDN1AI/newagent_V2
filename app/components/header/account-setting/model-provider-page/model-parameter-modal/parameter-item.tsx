...
const ParameterItem: FC<ParameterItemProps> = ({
  ...
  const renderInput = () => {
    ...
    if (parameterRule.type === 'int' || parameterRule.type === 'float') {
      console.log("Max Value:-------------------------->", parameterRule.max);
      let step = 100
      // parameterRule.max = 131072
      if (parameterRule.max) {
        if (parameterRule.max < 10)
          ...
          step = 100
        else if (parameterRule.max === 163840)
          step = 10
        // else if (parameterRule.max < 100000)
        //   step = 100
        // else if (parameterRule.max < 1000000)
        //   step = 100
      }
